...
public class Level_25_Cloud_Testing_With_SauceLabs extends BaseTest {
	@Description("Pre-Condition: Opening web application and login to system")
	@Severity(SeverityLevel.BLOCKER)
	@Parameters({ "browser", "osName", "browserVersion" })
	@BeforeClass
	public void beforeClass(String browserName, String osName, String browserVersion) {
		userNameAdmin = "Admin";
		...
		driver = getBrowserDriverInSauceLabs(browserName, osName, browserVersion);
